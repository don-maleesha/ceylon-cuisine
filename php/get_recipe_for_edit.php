...
try {
    $recipe['ingredients_list'] = json_decode($recipe['ingredients'], true) ?? [];
    $recipe['instructions_list'] = json_decode($recipe['instructions'], true) ?? [];
} catch (Exception $e) {
    // If there's an error parsing the JSON, set empty arrays
